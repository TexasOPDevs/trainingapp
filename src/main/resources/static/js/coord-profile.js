...
var provider = function($) {
    ...
    request.done(function (provider) {
        ...
        <div class="card-action">
           ...
           html += `<table class="responsive-table highlight"><thead><tr><th>Name</th><th>Email</th><th>Phone</th><th>Role</th><th>Make Instructor</th></tr></thead><tbody>`;
...
(function($) {
    ...
    request.done(function (curricula) {
        ...
        console.log(curricula);
        var html = '<table class="responsive-table highlight"><thead><tr><th>Course Name</th><th>Location</th><th>Start Date</th><th>End Date</th><th>Status</th><th>Instructors</th></tr></thead><tbody>';
        curricula.forEach(function(cur) {
