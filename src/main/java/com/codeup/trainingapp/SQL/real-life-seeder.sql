...
VALUES ('18', '2019-07-09', 2, 1, 3),
       ...
       ('14', '2019-07-09', 2, 1, 8),
       ('15', '2019-07-09', 2, 1, 9),
       ('17', '2019-07-09', 2, 1, 10),
       ('12', '2019-07-09', 2, 1, 11),
       ('19', '2019-07-09', 2, 1, 12),
       ('20', '2019-07-09', 2, 1, 13),
       ('18', '2019-07-09', 2, 1, 14),
       ...
       ('18', '2019-07-10', 2, 4, 8),
       ('15', '2019-07-10', 2, 4, 9),
       ('17', '2019-07-10', 2, 4, 10),
       ('13', '2019-07-10', 2, 4, 11),
       ('18', '2019-07-10', 2, 4, 12),
       ('17', '2019-07-10', 2, 4, 13),
       ('18', '2019-07-10', 2, 4, 14),
       ...
       ('28', '2019-07-11', 2, 5, 8),
       ('25', '2019-07-11', 2, 5, 9),
       ('26', '2019-07-11', 2, 5, 10),
       ('11', '2019-07-11', 2, 5, 11),
       ('22', '2019-07-11', 2, 5, 12),
       ('28', '2019-07-11', 2, 5, 13),
       ('27', '2019-07-11', 2, 5, 14);
